  ...
  dayNarratives: [
    {
      ...
      mood: '忐忑',
      sceneBg: '#F5E6D3',
      text: '今天是接手书店的第一天。祖父走了以后，镇上的人都说这家店撑不过这个月。我看着积灰的柜台和泛黄的书页，深吸一口气——不管怎样，得开门。\n\n门外的橡木镇还在沉睡。我摸到口袋里祖父留下的那把铜钥匙，冰凉的。\n\n"至少今天，会有人来。"',
      goal: '今天会有两位客人走进来。听听他们的故事，为他们推荐一本书。',
      hopeHint: 50
    },
    {
      day: 2,
      ...
      mood: '不安',
      sceneBg: '#E8DCC8',
      text: '第一天的两个人离开后，店里安静得能听见灰尘落在书脊上的声音。我不知道我推荐的书记住了没有——林月会不会翻开它？陈伯会原谅他的孙子吗？\n\n我擦着柜台的时候发现祖父刻在木纹上的字："书是钥匙，不是答案。"\n\n今天会有新的面孔。希望和昨天不一样。',
    ...
    },
    {
      ...
      mood: '紧张',
      sceneBg: '#DDD0BE',
      text: '昨晚镇上下了雨。屋顶漏了两处，我用祖父的旧茶缸接水。水滴砸在搪瓷上的声音让我睡不着。\n\n我开始怀疑——我真的能做这件事吗？每个人都在找答案，而我只是一个守着旧书店的年轻人。\n\n但今天门还是要开。因为关上门就真的什么都没有了。',
